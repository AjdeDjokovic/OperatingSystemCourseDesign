...
//----------------------------------------------------------------------
// Copy
// 	Copy the contents of the UNIX file "from" to the Nachos file "to" 将UNIX文件的内容“from”复制到Nachos文件“to”
//----------------------------------------------------------------------
...
//        after the end of file "to". 将UNIX文件的内容“from”附加到Nachos文件“to”。如果“half”为非零，则从文件“to”的中间开始追加“from”的内容；否则，在文件“to”的结尾后进行真正的追加。
//
